...
namespace ntk
{
    namespace Graphics
    {
        ...
        protected:
            ...
            /// @brief 附着的顶点着色器对象
            Utils::SharedPointer<Shader> m_geometry_shader;
        ...
        public:
            ...
            GeometryProgram(const SelfType &from) = default;
            ~GeometryProgram() = default;
        ...
        public:
            ...
            /// @brief 获取几何着色器对象
            /// @return 几何着色器对象
            const Utils::SharedPointer<Shader> &get_geometry_shader() const;
        ...
        public:
            ...
            /// @param fshader 片段着色器
            /// @return 是否加载（链接）成功
            virtual bool load_from_shader(const Utils::SharedPointer<Shader> &vshader, const Utils::SharedPointer<Shader> &gshader, const Utils::SharedPointer<Shader> &fshader);
