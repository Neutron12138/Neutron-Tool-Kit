...
namespace ntk
{
    namespace Graphics
    {
        Shader::Shader(ShaderType::ShaderType shader_type) : GLObject(), m_shader_type(shader_type) {}
        Shader::Shader(ShaderType::ShaderType shader_type, GLuint shaderID) : m_shader_type(shader_type) { set_shaderID(shaderID); }

        ShaderType::ShaderType Shader::get_shader_type() const
        {
        ...
        bool Shader::load_from_string(const std::string &source)
        {
            ...
            GLuint shaderID = glCreateShader(static_cast<GLenum>(m_shader_type));
        ...
        {
            m_objectID = glCreateShader(static_cast<GLenum>(m_shader_type));
        }
