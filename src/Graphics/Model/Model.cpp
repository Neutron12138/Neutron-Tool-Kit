...
namespace ntk
{
    namespace Graphics
    {
        ...
        VertexArrayObject Model<m_VertexType, m_NormalType, m_TexCoordType>::generate_VAO()
        {
            ...
            VAO.generate();
            VAO.bind();
            VertexBufferObject VBO1 = VertexBufferObject::createVBO_single(m_vertices, VertexAttributeEnum::VertexAttributeLocation::Position, GL_STATIC_DRAW);
            VertexBufferObject VBO2 = VertexBufferObject::createVBO_single(m_normals, VertexAttributeEnum::VertexAttributeLocation::Normal, GL_STATIC_DRAW);
            VertexBufferObject VBO3 = VertexBufferObject::createVBO_single(m_texCoords, VertexAttributeEnum::VertexAttributeLocation::TexCoord, GL_STATIC_DRAW);
            VAO.unbind();
            VBO1.unbind();
            VBO1.delete_object();
            VBO2.delete_object();
