...
namespace ntk
{
    namespace Graphics
    {
        /// @brief 模型类。旧版，现用VertexArray代替
        /// @tparam m_VertexType 顶点数据类型
        /// @tparam m_NormalType 法线数据类型
        /// @tparam m_TexCoordType 纹理坐标数据类型
        ...
        public:
            /// @brief 生成顶点数组对象
            /// @return 顶点数组对象
            virtual VertexArrayObject generate_VAO(const Program &program, const VertexAttribDescriber &describer);
        };
    } // namespace Graphics
