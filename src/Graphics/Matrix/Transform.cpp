...
namespace ntk
{
    namespace Graphics
    {
        ...
        Transform Transform::translated(const glm::vec3 &translation)
        {
        ...
        Transform Transform::rotated(const glm::vec3 &rotation)
        {
            Transform result = *this;
        ...
        Transform Transform::scaled(const glm::vec3 &scale)
        {
            Transform result = *this;
            result.scale(scale);
            result.update();
