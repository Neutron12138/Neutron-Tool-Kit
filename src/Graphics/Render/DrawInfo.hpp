...
namespace ntk
{
    namespace Graphics
    {
        ...
        public:
            ...
            DrawInfo(PrimitiveType::PrimitiveType primitive_type, GLint first, GLsizei count, GLsizei instance_count);
        ...
        public:
            ...
            /// @brief 设置要绘制的实例总数
            /// @param instance_count 要绘制的实例总数
            void set_instance_count(GLsizei instance_count);
