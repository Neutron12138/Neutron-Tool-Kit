    ...
    namespace Graphics
    {
        ...
        void BasicModelObject<VertexModel>::create()
        {
            ...
            if (m_draw_info.get() == nullptr)
                m_draw_info = std::make_shared<DrawInfo>(DrawType::DrawType::Arrays, PrimitiveType::PrimitiveType::Triangles, 0, BasicModelObject<VertexModel>::ParentType::ParentType::m_vertices.size());
        }
