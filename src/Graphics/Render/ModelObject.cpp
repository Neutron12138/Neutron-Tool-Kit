...
namespace ntk
{
    namespace Graphics
    {
        BasicModelObject<VertexModel>::BasicModelObject(const typename BasicModelObject<VertexModel>::VertexModelType &model) : BasicModelObject<VertexModel>::ParentType(model)
        {
            create();
            update_VAO();
        }

        BasicModelObject<VertexModel>::BasicModelObject(const typename BasicModelObject<VertexModel>::VertexModelType &model, const DrawInfo &draw_info) : BasicModelObject<VertexModel>::ParentType(model)
        {
            create();
