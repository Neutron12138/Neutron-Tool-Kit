...
namespace ntk
{
    BasicStringStream<std::char_traits<wchar_t>, std::allocator<wchar_t>>::BasicStringStream() : BasicStringStream<std::char_traits<wchar_t>, std::allocator<wchar_t>>::ParentType() {}
    ...
    BasicStringStream<std::char_traits<wchar_t>, std::allocator<wchar_t>>::~BasicStringStream() {}
