#ifndef __NEUTRON_BASE_BASICSTRING_HPP__
#define __NEUTRON_BASE_BASICSTRING_HPP__
...
namespace ntk
{
    ...
    class BasicString : public Object, public std::basic_string<wchar_t, m_TraitsType, m_AllocatorType>
    {
    public:
        /// @brief 字符类型
