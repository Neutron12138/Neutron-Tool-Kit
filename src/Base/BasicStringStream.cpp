...
namespace ntk
{
    ...
    BasicStringStream<m_TraitsType, m_AllocatorType>::BasicStringStream() : BasicStringStream<m_TraitsType, m_AllocatorType>::ParentType() {}
    template <typename m_TraitsType, typename m_AllocatorType>
    ...
    template <typename m_TraitsType, typename m_AllocatorType>
    BasicStringStream<m_TraitsType, m_AllocatorType>::~BasicStringStream() {}
