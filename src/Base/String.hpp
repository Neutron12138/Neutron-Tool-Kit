#ifndef __NEUTRON_BASE_STRING_HPP__
#define __NEUTRON_BASE_STRING_HPP__
...
namespace ntk
{
    /// @brief 字符串对象，为STL特化
    template <>
    class BasicString<std::char_traits<wchar_t>, std::allocator<wchar_t>> : public Object, public std::basic_string<wchar_t, std::char_traits<wchar_t>, std::allocator<wchar_t>>
    {
    public:
        /// @brief 字符类型
    ...
    public:
        ...
        BasicString(const SelfType &from);
        ~BasicString();
