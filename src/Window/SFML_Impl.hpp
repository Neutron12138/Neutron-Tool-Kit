...
namespace ntk
{
    ...
    {
        /// @brief 默认的SFML上下文设置
        static const sf::ContextSettings DEFAULT_SF_CONTEXT_SETTINGS = sf::ContextSettings(16, 8, 4, 3, 3, sf::ContextSettings::Attribute::Core | sf::ContextSettings::Attribute::Debug, false);
        ...
        protected:
            /// @brief 窗口实例
            Utils::SharedPointer<sf::RenderWindow> m_window;
