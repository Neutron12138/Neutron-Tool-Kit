...
namespace ntk
{
    namespace Utils
    {
        ...
        protected:
            ...
            /// @brief 倒计时的时长
            Time m_duration = Instance::ZeroSecond;

            /// @brief 剩余时间
            Time m_time_remaining = Instance::ZeroSecond;
        ...
        public:
            ...
            CountdownTimer(const CountdownTimer &from) = default;
            ~CountdownTimer() = default;

        public:
            CountdownTimer &operator=(const CountdownTimer &from) = default;
        ...
        public:
            ...
            /// @return 本对象
            CountdownTimer &start(CountdownType countdown_type = CountdownType::Async);
