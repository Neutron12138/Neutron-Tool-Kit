...
namespace ntk
{
    namespace Utils
    {
        ...
        template <typename ArgT>
        std::wstring to_wstring(const ArgT &arg)
        {
        ...
        template <typename ArgT, typename... ArgsT>
        std::wstring to_wstring(const ArgT &arg, const ArgsT &...args)
        {
            return to_wstring(arg) + to_wstring(args...);
        }

        String construct_string()
        {
            return String(to_wstring());
        }

        template <typename ArgT>
        String construct_string(const ArgT &arg)
        {
            return String(to_wstring(arg));
        }

        template <typename ArgT, typename... ArgsT>
        String construct_string(const ArgT &arg, const ArgsT &...args)
        {
            return String(to_wstring(arg, args...));
        }
    } // namespace Utils
